...
| **Milestone 2: Database & Persistence**        | :hourglass_flowing_sand: In Progress | PostgreSQL schema, migrations, relational constraints, foreign keys, transactions & connection pooling                                                                                                                                                                  |
| ├── **Phase 2.1: PostgreSQL Setup**            |     :white_check_mark: Completed     | PostgreSQL migration suite (001-005), dev & test profiles, database recreation runner ([Report](docs/reports/phase-2.1-verification-report.md))                                                                                                                         |
...
| ├── **Phase 2.3: Database Constraints**        |    :hourglass_flowing_sand: Next     | Primary keys, foreign keys, unique constraints, check constraints, indexes                                                                                                                                                                                              |
| └── **Phases 2.4–2.6**                         |        :white_circle: Pending        | Connection pooling, Transactions, Repositories, Migrations execution                                                                                                                                                                                                    |
